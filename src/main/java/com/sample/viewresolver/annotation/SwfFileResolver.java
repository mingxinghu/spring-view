...
import com.sample.view.annotation.SwfFileView;
 ...
 */
@Component
public class SwfFileResolver extends AbstractCachingViewResolver implements Ordered {

    private Logger logger = Logger.getLogger(SwfFileResolver.class.getName());

    private int order = Integer.MIN_VALUE;

    // requested file location under web app
    private String location = "/WEB-INF/swf/";

    @Autowired
    private SwfFileView view;
